...
jQuery.validator.addMethod("validatfile", function(value, element) {
    var file = /(\.jpg|\.png|\.gif|\.jpeg|\.bmp|\.doc|\.docx|\.xls|\.xlsx|\.ppt|\.pptx|\.pdf|\.txt)$/;
    return this.optional(element) || (file.test(value.toLowerCase()));
}, "请输入有效的文件,后缀为 .jpg .png .jpeg .gif .bmp .doc .docx .xls .xlsx .ppt .pptx .pdf .txt");