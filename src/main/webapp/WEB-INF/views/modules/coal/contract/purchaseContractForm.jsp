...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/coal/contract/purchase/">采购合同列表</a></li>
    <li class="active"><a href="${ctx}/coal/contract/purchase/form?contractSid=${purchaseContract.contractSid}">合同<shiro:hasPermission name="coal:contract:edit">${not empty purchaseContract.contractSid?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="coal:contract:edit">查看</shiro:lacksPermission></a></li>
</ul><br/>
<form:form id="inputForm" modelAttribute="purchaseContract" action="${ctx}/coal/contract/purchase/save" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input id="signDate" name="signDate" type="text" readonly="readonly" class="Wdate input-medium"
                       value="<fmt:formatDate value="${purchaseContract.signDate}" pattern="yyyy-MM-dd"/>"
...
<tr>
    <td>
        <div class="control-group">
            ...
            <div class="controls">
                <tags:commonselect id="supplyId" name="supplyId" value="${purchaseContract.supplyId}" labelName="supplyName" labelValue="${fncoal:getSupplyName(purchaseContract.supplyId)}"
    ...
    <td>
        <div class="control-group">
            ...
            <div class="controls">
                <tags:commonselect id="demandId" name="demandId" value="${purchaseContract.demandId}" labelName="demandName" labelValue="${fncoal:getDemandName(purchaseContract.demandId)}"
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input id="startDate" name="startDate" type="text" readonly="readonly" class="Wdate input-medium"
                       value="<fmt:formatDate value="${purchaseContract.startDate}" pattern="yyyy-MM-dd"/>"
                onClick="WdatePicker()" class="required"/>
            </div>
        </div>
    </td>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input id="endDate" name="endDate" type="text" readonly="readonly" class="Wdate input-medium"
                       value="<fmt:formatDate value="${purchaseContract.endDate}" pattern="yyyy-MM-dd"/>"
                onClick="WdatePicker()" class="required"/>
            </div>
        </div>
    </td>
...
<c:if test ="${not empty purchaseContract.files}">
    <tr>
        <td  colspan="3">
            <div class="control-group">
                ...
                <div class="controls">
                    <ul style="list-style-type: none;margin-left:0;">
                        <c:forEach items="${purchaseContract.files}" var="file">
                            <li id ="file${file.id}">
                                <a href='${ctx}/coal/contract/purchase/delFile?id=<c:out value="${file.id}"/>&prjId=${purchaseContract.contractSid}'/><span class="btn">删 除</span></a>&nbsp;&nbsp;
